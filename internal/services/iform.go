...
func UpdateIform(ctx context.Context, pipelineId string, input models.UpdateIformInput, updatedBy string) (bool, error) {
	return datastore.UpdateIform(ctx, pipelineId, input, updatedBy)
}

func Iform(ctx context.Context, pipelineID, myID, myName string, myRole []*string) (*models.Iform, error) {
	...
	return datastore.GetIformByPipelineId(ctx, pipelineID)
}

func IformByOrderNumber(ctx context.Context, orderNumber string) (*models.Iform, error) {
	return datastore.GetIformByOrderNumber(ctx, orderNumber)
}
