...
type PipelineNote struct {
	...
	OrderNotes                  *string             `bson:"orderNotes,omitempty"`
	InspectionNotes             *string             `bson:"inspectionNotes,omitempty"`
...
func (u *PipelineNote) ToModels() *models.PipelineNote {
	return &models.PipelineNote{
		ID:                          strings.ToObject(u.ID.Hex()),
		OrderNotes:                  u.OrderNotes,
		InspectionNotes:             u.InspectionNotes,
